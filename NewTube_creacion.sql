...
ALTER TABLE `like_dislike` ADD FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`);

ALTER TABLE `like_dislike` ADD FOREIGN KEY (`id_video`) REFERENCES `video` (`id_video`);
...
INSERT INTO like_dislike(id_user, id_video, type) VALUES (2, 1, 'like'), (3, 1, 'like'), (4, 1, 'like'), (2, 2, 'dislike'), (3, 2, 'dislike'), (4, 2, 'dislike'), (2, 3, 'like'), (3, 3, 'dislike'), (4, 3, 'like'); 
